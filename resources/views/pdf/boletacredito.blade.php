...
<html lang="es">
    ...
    <script src="https://cersa.org.pe/emails/numLetras.js"></script>
  </head>
...
?>
	...
	<div class="row">
        <div class="col md-8">
            ...
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <font size="3">N° {{$c->id-179}} </font ><br>
          ...
          <p><font size="2">Recibí de la Cooperativa Agraria Productos de Tara del Norte la cantidad de : <br>
            <?php echo numtoletras($c->montodesembolsado*$c->tipocambio) ?> <br>
            <strong>Por Concepto de : </strong>
            <br>
            
            Prestamo ID SM {{$c->idkiva}} a {{$c->nombre}} {{$c->apellidopaterno}} {{$c->apellidomaterno}} <br>
            </font>
        </p>
        <hr>
...
APT DEL NORTE                           D.N.I: {{$c->dni}}
  ...
  @endforeach
    ...
    <script>
     document.getElementById("resultado").innerHTML=NumeroALetras(10.20, 'SOLES');
    </script>
